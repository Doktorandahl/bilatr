...
# EventRootCode3 / EventRootCode4 / BilatrClass / BilatrClass2 recodings
# (each with a *Name label where it has one, including
# EventRootCode2Name, EventRootCode3Name, and EventRootCode4Name;
